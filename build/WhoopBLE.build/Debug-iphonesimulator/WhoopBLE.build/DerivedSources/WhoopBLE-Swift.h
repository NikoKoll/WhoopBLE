...
#ifndef WHOOPBLE_SWIFT_H
#define WHOOPBLE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="WhoopBLE",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8WhoopBLE10BLEManager")
...
@interface BLEManager (SWIFT_EXTENSION(WhoopBLE)) <CBPeripheralDelegate>
...
@class NSString;
@class NSNumber;
@interface BLEManager (SWIFT_EXTENSION(WhoopBLE)) <CBCentralManagerDelegate>
